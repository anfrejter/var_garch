...
colnames(summary_in_sample) <- c("model","n_below_VAR95_in","%_below_VAR95_in","n_below_VAR99_in","%_below_VAR99_in")
summary_in_sample

summary_in_sample %>% 
  datatable(rownames = FALSE, options = list(dom = 't', ordering = FALSE), class = 'cell-border stripe') %>% 
  formatPercentage(columns = c("%_below_VAR95_in","%_below_VAR99_in"), digits = 2)
```
...
colnames(summary_out_of_sample) <- c("model","n_below_VAR95_out","%_below_VAR95_out","n_below_VAR99_out","%_below_VAR99_out")

summary_out_of_sample %>% 
  datatable(rownames = FALSE, options = list(dom = 't', ordering = FALSE), class = 'cell-border stripe') %>% 
  formatPercentage(columns = c("%_below_VAR95_out","%_below_VAR99_out"), digits = 2)

cbind(summary_in_sample,summary_out_of_sample[,c("n_below_VAR95_out","%_below_VAR95_out","n_below_VAR99_out","%_below_VAR99_out")]) %>% 
datatable(rownames = FALSE, options = list(dom = 't', ordering = FALSE), class = 'cell-border stripe') %>% 
  formatPercentage(columns = c('%_below_VAR95_in',"%_below_VAR99_in","%_below_VAR95_out","%_below_VAR99_out"), digits = 2)
```