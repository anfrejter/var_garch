...
```{r}
cbind(merged$SP_CulReturns,merged$NVDA_CulReturns,merged$EURUSD_CulReturns, merged$XRP_CulReturns, SNEUCX_index$index_value)

ggplot(cbind(merged$SP_CulReturns,merged$NVDA_CulReturns,merged$EURUSD_CulReturns, merged$XRP_CulReturns, SNEUCX_index$index_value)) +
